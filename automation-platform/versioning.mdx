...
icon: "clock"
description: "Learn how flow versioning works in Clever Marketing Voice AI"
---

Clever Voice AI keeps track of all published flows and their versions. Here’s how it works:
...
4. If you try to edit a published flow, Clever Voice AI will create a new **draft** if there is none and copy the **published** version to the new version.
