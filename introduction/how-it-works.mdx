...
description: "Understand the technical flow of how Clever Voice AI processes and handles phone conversations using AI"
---

Clever Voice AI blends **AI voice recognition** with **LLM-based replies** to conduct live phone conversations. Below is a simplified flow:

1. **Caller or Lead is Dialed**

   - **Inbound**: A customer dials your assigned phone number.
   - **Outbound**: Clever Voice AI's system calls a list of phone numbers from your campaign.

2. **Speech Recognition**  
   The AI listens to what the person says and transcribes it into text in real time.

3. **LLM Decision**  
   Clever Voice AI uses a large language model (LLM) and your configured "system prompt" to craft a reply or decide the next action (like transferring the call).
