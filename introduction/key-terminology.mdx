...
icon: "book"
description: "Essential terms and concepts you need to know to use Clever Voice AI effectively"
---

Understanding these terms will help you navigate Clever Voice AI more easily:
...
Clever Voice AI's built-in workflow platform, similar to Zapier/Make. It lets you connect triggers (like "call ended") to actions (like "send an email" or "update a Google Sheet") without writing code.
...
A method to connect your existing phone system or VOIP provider with Clever Voice AI without renting new numbers.
