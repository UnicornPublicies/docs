...
icon: "credit-card"
description: "Learn how Clever Voice AI billing works, including call minutes calculation, phone number rentals, and usage monitoring"
---

Clever Voice AI operates on a **usage-based** model. You pay primarily for two things:
...
- **Per-Second Billing**: Typically, Clever Voice AI bills by the second (converted to minutes). For example, a 90-second call is 1.5 minutes.
