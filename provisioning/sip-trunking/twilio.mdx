...
{/* - If you opt for the auth route, you need to specify the username and password in the next step when importing the number to Clever Voice AI.
   <Frame>
     <img
...
- Currently SIP server does not have a static IP, so if you opt for the IP route, you need to whitelist all the IP addresses in the range like following:
...
- Here you will specify SIP server address as the origination SIP URI: ```sip:5wed79aeavr.sip.livekit.cloud ``` 
...
## Step 3: Import numbers to Clever Voice AI

Now the number is set up with your elastic SIP trunking, you need to import the number to Clever Voice AI so that we will know how to route the call.
...
3. Click “Integrate SIP trunk”
   ...
   <Frame>
     <img
       ...
       alt="Import numbers to Clever Marketing Voice AI"
     />
   </Frame>
...
{/* - If you opted for auth route select Username and password.
   ...
   <Frame>
     <img
       ...
       alt="Twillio Clever Voice AI Credentials Auth Type"
     />
   </Frame> */}
...
```
   <Frame>
     <img
       ...
       alt="Twillio Clever Voice AI Credentials IP Type"
     />
   </Frame> 
...
7. Select the country of where your SIP trunk is located. 
    ...
    <Frame>
      <img
        ...
        alt="Twillio Clever Voice AI SIP Country"
      />
    </Frame>
