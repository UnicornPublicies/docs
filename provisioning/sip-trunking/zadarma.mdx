...
4. Click on external services and then check the option for SIP URI.
  ...
  Add ```sip:extension@5wed79aeavr.sip.livekit.cloud ``` (this is Clever Voice AI SIP server address) .
...
## Step 2: Import numbers to Clever Marketing Voice AI

You need to import to Clever Voice AI.
...
3. Click “Integrate SIP trunk”
   ...
   <Frame>
     <img
       ...
       alt="Import numbers to Clever Voice AI"
     />
   </Frame>
