...
<AccordionGroup>
  ...
  <Accordion title="Webhook URL" icon="link">
    ...
    **Example:** `https://automate.voice.ai/api/v1/webhooks/your-webhook-id`
...
```json
{
  ...
  "transcript": [
    {
      "text": "Hello! This is Doru from Clever Marketing.",
      "type": "transcript",
      "sender": "bot",
  ...
  "formatted_transcript": "AI: Hello! This is Doru from Clever Marketing.\\nCustomer: Hi, I'm doing well, thanks.",
  "recording_url": "https://voiceai.theclevermarketing.com/storage/recordings/call-12345.mp4",
