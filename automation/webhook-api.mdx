...
If you want deeper customization beyond no-code blocks, Clever Voice AI supports **webhooks** and a **REST API**.

## 1. Webhooks

- **When to Use**: Trigger events in external systems the moment something happens in Clever Voice AI (e.g., "Call Ended,").
...
**Note:** You'll find the official API reference in a dedicated docs section or via your dashboard. Always secure your tokens and test endpoints in a dev environment.
