...
description: "Learn about Clever Voice AI's built-in automation engine for creating workflows without coding"
---
...
Clever Voice AI includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside Clever Voice AI (e.g., "call ended," "inbound call context injection").
