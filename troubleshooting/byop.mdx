...
description: "Learn how to use your existing phone numbers or Twilio account with Clever Voice AI through SIP integration or Caller ID verification"
---
...
- Inbound & outbound will flow through your existing lines, but still utilize Clever's AI.
...
- Meanwhile, you can have the best of both worlds by provisioning Twilio-based numbers through Clever Voice AI or using a custom approach.
