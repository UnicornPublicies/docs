...
title: "Cost Overview"
icon: "dollar-sign"
description: "Understand the main components of Clever Voice AI pricing, including call minutes, number rentals, and optional fees"
---

Clever Voice AI uses a **credit/minute system** to track usage for both AI processing and carrier network fees. Here's how it breaks down:
...
2. **Acquire or Verify a Number**: Rent from Clever Voice AI or add your own as caller ID for outbound.
