...
```json 200 Response
{
  ...
  "first_page_url": "https://voiceai.theclevermarketing.com/api/user/assistants/get?page=1",
  "from": 1,
  "last_page": 5,
  "last_page_url": "https://voiceai.theclevermarketing.com/api/user/assistants/get?page=5",
  "links": [
    {
      "url": null,
    ...
    {
      "url": "https://voiceai.theclevermarketing.com/api/user/assistants/get?page=1",
      "label": "1",
      "active": true
    },
    {
      "url": "https://voiceai.theclevermarketing.com/api/user/assistants/get?page=2",
      "label": "2",
      "active": false
    }
  ],
  "next_page_url": "https://voiceai.theclevermarketing.com/api/user/assistants/get?page=2",
  "path": "https://voiceai.theclevermarketing.com/api/user/assistants/get",
  "per_page": 10,
  "prev_page_url": null,
  "to": 10,
  "total": 47
