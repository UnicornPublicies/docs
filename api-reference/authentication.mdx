...
1. Log in to your Autocalls account at [https://voiceai.theclevermarketing.com/](https://voiceai.theclevermarketing.com/)
...
```bash
curl -X GET "https://voiceai.theclevermarketing.com/api/user/campaigns" \
