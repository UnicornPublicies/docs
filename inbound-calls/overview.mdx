...
When someone dials your dedicated (or SIP-integrated) number, Clever Voice AI can answer automatically through an AI Assistant. This section covers the big-picture flow of inbound calling:
